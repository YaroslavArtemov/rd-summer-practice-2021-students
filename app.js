    ...
    (function (game) {
        game.GameView = (function () {
            function getGame() {
                ...
                return {
                    ...
                    team1: {
                        ...
                        $caption: document.getElementById('teamPoliceCaption'),
                    ...
                    team2: {
                        ...
                        $caption: document.getElementById('teamTheafCaption'),
            ...
            function getImages() {
                ...
                return {
                    imgHeart: document.getElementById('img_heart').get(0),
                    imgCoin: document.getElementById('imgCoin').get(0),
                    imgPolice: document.getElementById('imgPolice').get(0),
                    imgPoliceSelf: document.getElementById('imgPoliceSelf').get(0),
                    imgThief: document.getElementById('imgThief').get(0),
                    imgThiefSelf: document.getElementById('imgThiefSelf').get(0),
                    imgSwitch: document.getElementById('imgSwitch').get(0)
                };
            }
